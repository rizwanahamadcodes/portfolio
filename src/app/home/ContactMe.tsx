...
const ContactMe = () => {
    const inputClasses =
        'w-full rounded-md focus:shadow-primary-glow hover:shadow-primary-glow border dark:border-gray-800 border-gray-200 bg-transparent py-2 px-4 focus:outline-none focus:border-primary dark:focus:border-primary'
