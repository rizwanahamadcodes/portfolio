...
const GetInTouch = (props: GetInTouchProps) => {
    ...
    return (
        <a href={url}>
            <div className="inline-flex w-full items-center gap-1 rounded-full bg-white p-0.5 pr-1.5 shadow hover:shadow-lg transition-all active:scale-[0.98] dark:bg-gray-800">
