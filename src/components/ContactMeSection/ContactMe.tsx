...
const ContactMe = (props: ContactMeProps) => {
    ...
    return (
        <Section className={clsx("border-b border-b-gray-200 dark:border-b-gray-800 bg-gray-100 dark:bg-gray-900", className)}>
            <Container className="flex flex-col items-stretch justify-between gap-2 md:flex-row">
                <div className="relative grow md:max-w-md">
                    <SectionTitle defaultBottomMargin>Contact Me</SectionTitle>
                    <SectionSubtitle defaultBottomMargin>Drop a message</SectionSubtitle>
                    <GetInTouchSection />
                </div>
                <OrDivider />
                <ContactForm />
