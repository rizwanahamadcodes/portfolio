...
const Project = (props: ProjectProps) => {
    ...
    return (
        <div className="bg-white rounded-1 w-full  dark:bg-gray-800 shadow">
            <div className="px-0.5 pt-0.5">
                <div className="pb-[calc(calc(9_/_16)_*100%)] bg-red-500 relative">
                    <Image
                        src={project.projectImageSrc}
                        className="h-full w-full object-cover rounded-0.5"
                        fill
            ...
            <div className="p-1 flex gap-0.5">
                <div className="text-primary bg-primary-100 px-0.875 py-0.25 text-0.75 rounded-0.5">
                    HTML
                </div>
                <div className="text-primary bg-primary-100 px-0.875 py-0.25 text-0.75 rounded-0.5">
                    CSS
