                ...
                {navLinks.map((navLink, index) => (
                    ...
                    >
                        <Link
                            href={navLink.path}
                            className={cn(
                                'flex w-full select-none items-center pl-[7vw] text-sm font-semibold uppercase tracking-[0.125rem] transition-all duration-75 hover:bg-gray-900/5 dark:hover:bg-gray-100/5',
                                direction === 'column'
                                    ? 'h-nav-height'
                                    : 'h-full px-7',
